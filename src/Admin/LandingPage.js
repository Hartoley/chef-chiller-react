    ...
    <>
      ...
      <div>
        <div
          ...
          style={{
            backgroundImage:
              "url('https://i.pinimg.com/236x/13/f7/ab/13f7ab894c39396151c52b4b354b1aad.jpg')",
          }}
        >
          ...
          <div className="h-[14%] w-[100%] items-center justify-center p-0 m-0">
            <div className="bg-[rgba(4,14,25,0.95)] items-center justify-center h-full w-full flex text-white">
              <div className=" transform  flex space-x-2 z-20">
                {slides.map((_, index) => (
                  <div
                    key={index}
        ...
        <div
          id="listFood"
          className=" top-[70vh] bg-[rgb(8,21,33)] w-full flex justify-center items-center h-[12vh]"
        >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://i.pinimg.com/736x/6e/23/a6/6e23a6fccd6e331bb36d361b6179fbfa.jpg')",
          }}
        >
          {/* <img
            ...
            alt=""
          /> */}
          <div className="miniBoxDupli bg-[rgb(1,15,28)] z-10 opacity-95 flex items-center flex-col justify-center gap-10 p-10 ">
            <div
              id="miniBox1"
              className="bg-[rgb(5,17,31)] flex items-center rounded-tl-[50px] rounded-br-[50px] w-[80%] h-[55%]"
            >
              <div className="dishesChild flex w-[60%] p-3 h-[70vh] items-center justify-center gap-3 ">
                <div className="w-[50%] h-[100%] miniBoxme flex flex-col items-center justify-between">
                  <motion.img
              ...
              >
                ...
                <p className="text-[0.8rem] w-[90%] cursor-pointer hover:text-[rgb(175,16,60)] ">
                  Our restaurant offers exceptional service with friendly staff
                  who go above and beyond to make every visit memorable. We take
                  pride in creating a warm, welcoming atmosphere where guests
            ...
            <div
              id="coloredBox"
              className="bg-[rgb(5,17,31)] rounded-tl-[50px] flex items-center justify-between rounded-br-[50px] w-[80%] h-[50vh] p-2"
            >
